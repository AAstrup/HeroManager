...
public class DivisionFactory {
    ...
    public List<Division> CreateDivisions(List<IPlayer> players,List<int> days)
    {
        ...
        toReturn.Add(new Division(new BattleRandom(), RecreatePartOfList(0, 2, players), days[0],1));
        toReturn.Add(new Division(new BattleRandom(), RecreatePartOfList(2, 2, players), days[1],2));
        toReturn.Add(new Division(new BattleRandom(), RecreatePartOfList(4, 4, players), days[2],3));
        if (players.Count > 8)
